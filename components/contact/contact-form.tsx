...
const ContactForm: React.FC = () => {
  ...
  return (
    <section className="bg-background min-h-screen py-24">
          <div className="max-w-[1230px] 2xl:max-w-[1390px] mx-auto px-6 grid grid-cols-1 lg:grid-cols-5 pt-10  overflow-hidden">
              
              {/* empty space */}
              <div className='hidden lg:block lg:col-span-2'></div>
        {/* Left Column: Form */}
        <div className="lg:col-span-3 max-w-[572px] mx-auto md:-ml-20">
                  <h2 className="text-3xl font-medium text-foreground">Contact</h2>
