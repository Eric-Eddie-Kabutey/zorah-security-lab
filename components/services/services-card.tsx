  ...
  return (
    <motion.div variants={cardVariants}>
      <Link
        ...
        className="group bg-white rounded-xl shadow-sm hover:shadow-lg transition-all duration-300 h-full flex flex-col p-2"
      >        
        {service.coverImage && (
        ...
        <div className="flex flex-col flex-grow">
          ...
          <div className="mt-auto pt-6 text-sm font-medium text-foreground/80 flex items-center gap-2 group-hover:text-foreground">
            Learn more
