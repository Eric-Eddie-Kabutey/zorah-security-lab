      ...
      <div className="relative pt-24 flex items-center min-h-[80vh] justify-center">
        <div className="w-full relative grid grid-cols-1 md:grid-cols-5 items-center gap-12 md:gap-16 z-20">
          ...
          <div className="col-span-1 md:col-span-3">
            <h2 className="text-6xl sm:text-7xl md:text-9xl uppercase font-mono font-semibold text-gray-800 tracking-tighter">Stay</h2>
            <div className="relative inline-block border-1 border-gray-900/30 px-4 py-2 mt-2">
              <h2 className="text-6xl sm:text-7xl md:text-9xl uppercase font-mono font-semibold text-gray-800 tracking-tighter">updated</h2>
          ...
          <div className="w-full col-span-1 md:col-span-2 max-w-full md:max-w-[236px] md:mx-auto md:font-medium text-black text-left md:text-right">
          ...
          {/* Column 3: Form */}
          <div className="col-span-1 md:col-span-5 w-full mt-8 md:mt-0">
            {status === 'success' ? (
